...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset', default='any', help='Path to images')
        parser.add_argument('--load_ckpt', default='./nyu_rawdata.pth', help='Checkpoint path to load')
    ...
    def gather_options(self):
        ...
        self.parser = parser
        arg_filename_with_prefix = '@' + '/home/david/workspace/combi/vnl/arguments_vnl.txt'
        #test_args = TestOptions().parse_args([arg_filename_with_prefix])
        return parser.parse_args()

    def gather_options_file(self, txtfile):
        # initialize parser with basic options
        if not self.initialized:
            parser = argparse.ArgumentParser(
                formatter_class=argparse.ArgumentDefaultsHelpFormatter)
